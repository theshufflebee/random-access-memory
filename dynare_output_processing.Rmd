...
# Rename columns in your summary table to match the simulation columns for the join
...
# Merge all tables using the 'Variable' column
...
# Reorder rows to match the Cooley-Hansen Paper exactly
...
# Generate the LaTeX Output with Grouped Headers and Exact Lines
final_table_1 %>%
...
# Top Row: U.S. and Constant Growth
...
# Print the combined code to console
