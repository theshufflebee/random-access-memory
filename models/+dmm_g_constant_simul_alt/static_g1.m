...
if T_flag
    T = dmm_g_constant_simul_alt.static_g1_tt(T, y, x, params);
end
g1 = zeros(17, 17);
g1(1,7)=params(6);
g1(2,1)=(-(params(6)*params(7)*y(8)))/(params(7)*y(1)*y(8)*params(7)*y(1)*y(8));
g1(2,6)=(-((-(y(8)*params(4)))/(y(6)*y(8)*y(6)*y(8))));
g1(2,8)=(-(params(6)*params(7)*y(1)))/(params(7)*y(1)*y(8)*params(7)*y(1)*y(8))-(-(y(6)*params(4)))/(y(6)*y(8)*y(6)*y(8));
g1(3,1)=y(8);
g1(3,8)=y(1);
g1(4,2)=(-y(6));
