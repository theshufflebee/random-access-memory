...
if T_flag
    T = dmm_base_play_arround.dynamic_g1_tt(T, y, x, params, steady_state, it_);
end
g1 = zeros(18, 28);
...
g1(4,10)=(-y(1));
g1(4,11)=(-1)/(y(11)*y(11));
g1(5,5)=(-((1-params(3))*y(12)*(-y(1))/(y(5)*y(5))*T(7)));
g1(5,1)=(-((1-params(3))*y(12)*T(7)*T(9)));
g1(5,9)=1;
g1(5,12)=(-((1-params(3))*T(2)));
g1(6,5)=(-(params(3)*y(12)*(-y(1))/(y(5)*y(5))*T(8)));
g1(6,1)=(-(params(3)*y(12)*T(8)*T(9)));
g1(6,10)=1;
g1(6,12)=(-(params(3)*T(3)));
g1(7,5)=(-(T(5)*getPowerDeriv(y(5),1-params(3),1)));
g1(7,1)=(-(T(6)*y(12)*getPowerDeriv(y(1),params(3),1)));
g1(7,8)=1;
g1(7,12)=(-(T(4)*T(6)));
g1(8,4)=1;
g1(8,7)=1;
