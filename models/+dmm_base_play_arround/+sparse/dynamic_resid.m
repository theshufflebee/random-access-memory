...
[T_order, T] = dmm_base_play_arround.sparse.dynamic_resid_tt(y, x, params, steady_state, T_order, T);
residual = NaN(18, 1);
    ...
    residual(10) = (log(y(28))) - ((1-params(2))*log(params(7))+params(2)*log(y(10))+x(2));
    ...
    residual(17) = (y(35)) - (log(y(23)/y(20)));
